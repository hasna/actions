...
export function actionInvocationToWorkRun(
  ...
  const draft: WorkRunInput = {
    ...
    metadata: pruneUndefined({
      ...
      idempotencyKeyRedacted: invocation.idempotencyKey !== undefined ? true : undefined,
      inputRedacted: true,
...
export function actionRunToWorkRun(run: ActionRun, options: ActionRunContractOptions = {}): WorkRun {
  ...
  const draft: WorkRunInput = {
    ...
    metadata: pruneUndefined({
      ...
      idempotencyKeyRedacted: run.invocation.idempotencyKey !== undefined ? true : undefined,
      inputRedacted: true,
